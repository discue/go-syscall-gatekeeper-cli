...
nohup $main_path run --no-enforce-on-startup --on-syscall-denied=error --trigger-enforce-on-log-match="Starting server" --allow-network-server ./.tmp/server &> .tmp/log.txt  &
