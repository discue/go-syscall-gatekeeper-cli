...
declare -r owner="cuandari"
declare -r name="$owner"
declare -r repo="lib-oss"

declare -r latest_release_url=$(curl -Ls -o /dev/null -w %{url_effective} https://github.com/${owner}/${repo}/releases/latest)
...
declare -r shasum_url=https://github.com/${owner}/${repo}/releases/download/${latest_version}/sha256sums.txt
declare -r binary_url=https://github.com/${owner}/${repo}/releases/download/${latest_version}/${latest_version_name}
